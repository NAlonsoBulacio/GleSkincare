...
const Header = () => {
  ...
  return (
    <div>
      <div
        className="z-40 top-0 right-0 w-screen bg-white mx-auto flex items-center px-10 py-6 justify-between lg:hidden"
        style={{ maxWidth: "1150px", height: "100px" }}
      >
        <div className="w-full flex justify-center items-center">
          <a href="/">
            <img className="w-[105px]" src="https://cdn.shopify.com/s/files/1/0436/0673/7049/files/logo_1.png?v=1613788072&width=500" alt="Logo" />
          </a>
        </div>
      </div>
      <div className="hidden lg:flex justify-center items-center  w-screen h-32 bg-white shadow-lg lg:px-20 xl:px-36 py-2 z-40">
        <div className="flex justify-center items-center h-full">
          <img className="h-full" src="https://cdn.shopify.com/s/files/1/0436/0673/7049/files/logo_1.png?v=1613788072&width=500" alt="logo-galindosa" />
        </div>
        {/* <div className="w-2/3">
